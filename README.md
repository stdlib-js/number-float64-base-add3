...
```javascript
import add3 from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-add3@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/number-float64-base-add3/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/number-float64-base-add3/actions/workflows/test.yml?query=branch:v0.1.1
